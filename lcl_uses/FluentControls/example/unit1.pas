...
type
  ...
  TForm1 = class(TForm)
    ...
    FluentHyperlinkButton1: TFluentHyperlinkButton;
    ...
    FluentIconButton6: TFluentIconButton;
    FluentIconView1: TFluentIconView;
    FluentIconView2: TFluentIconView;
    ...
    FluentProgressRing1: TFluentProgressRing;

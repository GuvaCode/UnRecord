...
uses
  ...
  Codebot.System, Codebot.Support, Codebot.Text.Formats, Codebot.Text.Json, 
  Codebot.Text, Codebot.Text.Xml, Codebot.Text.Store, Codebot.IO.SerialPort, 
  Codebot.Unique, LazarusPackageIntf;

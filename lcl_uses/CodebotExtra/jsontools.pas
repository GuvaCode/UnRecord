...
function TJsonNode.LoadFromUrl(const Url: string): Boolean;
var M: TMemoryStream;
    http: TFPHTTPClient;
    Load: Boolean;
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            J := UnicodeToSize(HexToInt(C[1], C[2], C[3], C[4]){%H-});
            if J = 0 then
              Exit(0);
            Inc(I, J - 1);
            Inc(C, 4);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        H := UnicodeToString(HexToInt(C[1], C[2], C[3], C[4]){%H-});
